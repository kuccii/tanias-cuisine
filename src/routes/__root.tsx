...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Best restaurant in Kigali at M&M Plaza, KG 8 Avenue, Gishushu, Gasabo. Authentic African grills, daily chef's buffet (12,000 RWF), coffee bar and catering for up to 800 guests. Reserve by WhatsApp." },
