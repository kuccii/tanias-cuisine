...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Tania's Cuisine & Lounge — Premium African Grill & Dining in Gishushu, Kigali" },
      ...
      { property: "og:title", content: "Tania's Cuisine & Lounge — Kigali's Premium Dining & African Grill Since 2018" },
      { property: "og:description", content: "Premium dining at M&M Plaza, Gishushu. African grills, Swahili fish, daily chef's buffet, coffee bar, catering for up to 800 guests." },
      ...
      { name: "twitter:title", content: "Tania's Cuisine & Lounge — Kigali's Premium Dining & African Grill" },
      { name: "twitter:description", content: "Premium dining at M&M Plaza, Gishushu. African grills, Swahili fish, daily buffet, coffee bar, catering." },
